...
class SpriteAtlas : public Texture
{
    public:
        ...
        void render(SDL_Renderer *renderer, unsigned int spriteIndex, int x, int y, double xScale = 1.0, double yScale = 1.0, SDL_Rect *clip = NULL, double angle = 0.0, SDL_Point *center = NULL, SDL_RendererFlip flip = SDL_FLIP_NONE) const;
        ...
        /// @param center Center point to rotate the texture at. Defaults at w/2, h/2 of the dest rect (image center).
        /// @param flip Whether to flip the texture horizontally or vertically.
        void renderStretched(SDL_Renderer *renderer, unsigned int spriteIndex, int x, int y, int drawWidth, int drawHeight, SDL_Rect *clip = NULL, double angle = 0.0, SDL_Point *center = NULL, SDL_RendererFlip flip = SDL_FLIP_NONE) const;
